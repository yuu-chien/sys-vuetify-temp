      ...
      <v-list-item>
        <v-list-item-content>
          ...
          <v-radio-group row dense hide-details="auto" class="mt-1">
            <v-radio label="Punch-in" value="" color="orange"></v-radio>
            <v-radio label="Punch-out" value="" color="orange"></v-radio>
          </v-radio-group>
        </v-list-item-content>
      </v-list-item>
        ...
        <v-list-item-content>
          ...
          <div>
            ...
            >
              ...
              <v-date-picker color="orange" v-model="date"></v-date-picker>
            </v-menu>
          </div>
        </v-list-item-content>
      </v-list-item>
